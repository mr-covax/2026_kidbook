...
На Большом адронном коллайдере ([ЦЕРН](16_antimatter.md)) ищут признаки [рождения частиц](18_mass_energy.md) [тёмной материи](01_matter.md) в столкновениях [протонов](03_atom_structure.md). [Тёмная материя](01_matter.md) проявлялась бы как «недостающая [энергия](18_mass_energy.md)» в событиях.
...
| **Эмерджентная [гравитация](14_fundamental_interactions.md)** | [Гравитация](14_fundamental_interactions.md) как энтропийная сила | Развивается |
...
1. **Ранняя Вселенная**: [Тёмная материя](01_matter.md) начала формировать гравитационные потенциальные ямы раньше обычной [материи](01_matter.md) (до рекомбинации)
...
3. **Галактики**: Каждая галактика окружена обширным гало [тёмной материи](01_matter.md)
...
*Автор: Караткевич Николай • Сгенерировано с [помощью](../../../2.1_society/rights_and_responsibilities/articles/police.md) ChatGPT • Слов: 570 • 2026-03-18*
